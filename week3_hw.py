...
def main():
        ...
        song3.play()
        podcast1.play()
        print(f"Length of playlist 1: {len(playlist1)}")
        print(f"Length of playlist 2: {len(playlist2)}")
        print(f"Tracks in playlist 1: {list(playlist1)}")
        print(f"Tracks in playlist 2: {list(playlist2)}")
        print(f"Combined playlist: {playlist1 + playlist2}")
        print(f"Total tracks created: {Track.total_tracks_created}")
        print(f"Most played track: {Playlist.most_played(playlist1)}")
